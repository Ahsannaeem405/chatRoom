<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="@yield('users')"><a href="{{url('admin/users')}}"><i class=" fa fa-user"></i><span
                        class="menu-title" data-i18n="Dashboard">Users</span></a></li>

                        <li class="@yield('Social')"><a href="{{url('#')}}"><i class="fa fa-cog"></i><span
                            class="menu-title" data-i18n="Dashboard">Social Login Setting</span></a></li>
                            <li class="@yield('Social')"><a href="{{url('/admin/radio')}}"><i class="fa fa-cog"></i><span
                                class="menu-title" data-i18n="Dashboard">Radio Setting</span></a></li>

                                <li class="@yield('Social')"><a href="{{url('/admin/clearchat')}}"><i class="fa fa-comment"></i><span
                                    class="menu-title" data-i18n="Dashboard">Clear Chat</span></a></li>
                                    <li class="@yield('Social')"><a href="{{url('/admin/clearguest')}}"><i class=" fa fa-user"></i><span
                                        class="menu-title" data-i18n="Dashboard">Clear Guest Users</span></a></li>
                                        <li class="@yield('Social')"><a href="{{url('/admin/role')}}"><i class=" fa fa-group"></i><span
                                            class="menu-title" data-i18n="Dashboard">User Roles</span></a></li>
                                            <li class="@yield('Social')"><a href="{{url('#')}}"><i class="far fa-smile"></i><span
                                                class="menu-title" data-i18n="Dashboard">Stickers</span></a></li>
                                                <li class="@yield('Social')"><a href="{{url('admin/appearance')}}"><i class="fa fa-presentation"></i><span
                                                    class="menu-title" data-i18n="Dashboard">Appearance</span></a></li>
                                                    <li class="@yield('Social')"><a href="{{url('/admin/header')}}"><i class=" fa fa-user"></i><span
                                                        class="menu-title" data-i18n="Dashboard">Header/Footer</span></a></li>
                                                        <li class="@yield('Social')"><a href="{{url('/admin/Ip')}}"><i class="fa fa-signal"></i><span
                                                            class="menu-title" data-i18n="Dashboard">IP/BAN</span></a></li>
                                                            <li class="@yield('Social')"><a href="{{url('/admin/setting')}}"><i class="fa fa-cog"></i><span
